...
export default function OrderDetailScreen() {
  ...
  const openRating = (targetId, label, targetType) => {
  ...
  const handleRating = async (data) => {
    try {
      ...
      showToast(err.response?.data?.message ?? 'Įvertinimo klaida', 'error')
      throw err
    }
  }
    ...
    <div>
      ...
      {showRating && (
        <RatingModal
          ...
          reviewedBalance={ratingTarget?.targetType === 'transportuotojas' ? (order?.transporter_points ?? null) : null}
