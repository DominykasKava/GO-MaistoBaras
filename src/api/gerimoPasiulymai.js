...
export const confirmGerimoDelivery = (id) =>
  client.put(`/gerimo-uzsakymai/${id}/confirm-delivery`).then((r) => r.data)

export const confirmGerimoReceipt = (id) =>
  client.put(`/gerimo-uzsakymai/${id}/confirm-receipt`).then((r) => r.data)
